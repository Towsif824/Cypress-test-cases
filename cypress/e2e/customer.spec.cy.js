describe('Customer Test Suit', ()=>{
    it('create customer', function(){
      ...
      cy.contains('Email').type('ih2.sandbox@gmail.com')//provide your user's email address
      ...
      cy.get(':nth-child(15) > :nth-child(1) > :nth-child(1) > .q-item__section--main > .q-item__label').click()
